...
Throughout this document, many terms used may be unfamiliar to the reader. Some of these terms are defined here. General methamtical terms are not defined here, as it is assumed that the reader has some education in basic mathematics up to and including ordinary differential equations.
